...
if __name__ == '__main__':
    ...
    f_train_path = "/data/users/c3471tl/tc204_20210621_2dcnn/dataset/tc204/train/"
    ...
    f_test_path = "/data/users/c3471tl/tc204_20210621_2dcnn/dataset/tc204/test/"
    ...
    # create model
    f_save_path = '/data/users/c3471tl/tc204_20210621_2dcnn/'
    for count in range(10):
        ...
        # plt.show()
        joblib.dump(cdf_x, f_save_path + "cdf_x_2dcnn.save")
        joblib.dump(cdf_y, f_save_path + "cdf_y_2dcnn.save")
